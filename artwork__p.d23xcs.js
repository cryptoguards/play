(function () {
    ...
    1: [function (a, b, c) {
        var d = a("../index"), viewer = d({width: .4, height: .4, followMouse: !0, followMotion: !0});
        document.getElementById('logo-container').appendChild(viewer.container)
    }, {"../index": 3}], 2: [function (a, b, c) {
        b.exports = {
            ...
            }, {"color": [35, 52, 71], "faces": [[11, 12, 13], [64, 65, 66]]}, {
                "color": [228, 117, 31],
        ...
        var B = j("gl-mat4/perspective"), multiply = j("gl-mat4/multiply"), lookAt = j("gl-mat4/lookAt"),
            invert = j("gl-mat4/invert"), rotate = j("gl-mat4/rotate"), transform = j("gl-vec3/transformMat4"),
            foxJSON = j("./fox.json"), SVG_NS = "http://www.w3.org/2000/svg";
        q.exports = function (t) {
            ...
            function r(t) {
                for (var e = t[0], n = t[1], r = t[2], i = t[3], o = t[4], a = t[5], l = t[6], u = t[7], s = t[8], f = t[9], h = t[10], c = t[11], d = t[12], w = t[13], v = t[14], g = t[15], m = 0; m < F; ++m) {
                    var p = N[3 * m], A = N[3 * m + 1], y = N[3 * m + 2], x = p * i + A * u + y * c + g;
            ...
            function o() {
                ...
                for (b.length = 0, t = 0; t < S.length; ++t) {
                    var o = S[t], a = o.indices, l = a[0], u = a[1], s = a[2], f = M[3 * l], h = M[3 * l + 1],
                        c = M[3 * u], d = M[3 * u + 1], w = M[3 * s];
            ...
            var h = t || {}, c = !!h.followMouse, d = !!h.followMotion, w = !!h.slowDrift, v = !0, g = [0, 0], m = .3,
                p = 400, A = 400, y = createNode("svg"), x = {x: 0, y: 0}, F = foxJSON.positions.length,
                N = new Float32Array(3 * F), M = new Float32Array(3 * F), b = [];
            h.pxNotRatio || (p = window.innerWidth * (h.width || .25) | 0, A = 0 | (window.innerHeight * h.height || p), "minWidth" in h && p < h.minWidth && (p = h.minWidth, A = p)), setAttribute(y, "width", p + "px"), setAttribute(y, "height", p + "px"), document.body.appendChild(y), function () {
                for (var t = foxJSON.positions, e = 0, n = 0; n < t.length; ++n) for (var r = t[n], i = 0; i < 3; ++i) N[e++] = r[i]
            }();
            var S = function () {
                for (var t = [], e = 0; e < foxJSON.chunks.length; ++e) for (var r = foxJSON.chunks[e], i = "rgb(" + r.color + ")", o = r.faces, a = 0; a < o.length; ++a) {
                    var l = o[a], u = createNode("polygon");
                    setAttribute(u, "fill", i), setAttribute(u, "stroke", i), setAttribute(u, "points", "0,0, 10,0, 0,10"), y.appendChild(u), t.push(new n(u, l))
                }
                return t
            }(), k = function () {
                var t = new Float32Array(3), e = new Float32Array([0, 1, 0]), n = new Float32Array(16),
                    r = new Float32Array(16), i = lookAt(new Float32Array(16), new Float32Array([0, 0, 400]), t, e),
                    o = invert(new Float32Array(16), i), a = new Float32Array(16), l = new Float32Array(3),
                    u = new Float32Array(16), s = new Float32Array([1, 0, 0]), f = new Float32Array([0, 1, 0]),
                    h = new Float32Array([0, 0, 1]);
                return function () {
                    var c = y.getBoundingClientRect(), d = c.width, v = c.height;
            ...
            return window.addEventListener("mousemove", function (t) {
                ...
                if (v || l(), d) {
                    const n = event.gamma, r = event.beta;
        ...
        var d = a("toggle-selection"), defaultMessage = "Copy to clipboard: #{key}, Enter";
        b.exports = copy
    }, {"toggle-selection": 12}], 5: [function (a, b, c) {
        function identity(t) {
        ...
        function invert(n, r) {
            var e = r[0], t = r[1], u = r[2], i = r[3], l = r[4], o = r[5], v = r[6], a = r[7], c = r[8], d = r[9],
                f = r[10], m = r[11], p = r[12], s = r[13], x = r[14], b = r[15], g = e * o - t * l, h = e * v - u * l,
                j = e * a - i * l, k = t * v - u * o, q = t * a - i * o, w = u * a - i * v, y = c * s - d * p,
                z = c * x - f * p, A = c * b - m * p, B = d * x - f * s, C = d * b - m * s, D = f * b - m * x,
        ...
        function lookAt(t, a, e, r) {
            var i, o, s, h, n, M, d, q, u, b, l = a[0], y = a[1], k = a[2], v = r[0], A = r[1], c = r[2], f = e[0],
                m = e[1], p = e[2];
        ...
        var x = g("./identity");
        j.exports = lookAt
    }, {"./identity": 5}], 8: [function (q, w, z) {
        function multiply(l, t, u) {
            var r = t[0], e = t[1], i = t[2], m = t[3], n = t[4], o = t[5], p = t[6], y = t[7], a = t[8], c = t[9],
                d = t[10], f = t[11], s = t[12], v = t[13], x = t[14], b = t[15], g = u[0], h = u[1], j = u[2],
                k = u[3];
        ...
        function rotate(t, a, r, e) {
            var o, n, s, h, u, M, l, c, i, b, d, f, m, p, q, v, x, g, j, k, w, y, z, A, B = e[0], C = e[1], D = e[2],
