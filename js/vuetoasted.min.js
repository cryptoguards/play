    ...
    return function(t) {
            ...
            ! function(n, a) {
                ...
                function j(t) {
                    ...
                    function i(t) {
                        for (var n = 0, r = {}, i = d.animations, o = i.length; n < o;) {
                            ...
                            if (l = c.length)
                                for (m = c[0], f = 0; f < l; f++) p = c[f + 1], v = u[f], isNaN(v) || (m = p ? m + (v + p) : m + (v + " "));
                            else m = u[0];
                            Y[a.type](s.target, a.property, m, r, s.id), a.currentValue = m, n++
                        }
                        if (n = Object.keys(r).length)
                            for (i = 0; i < n; i++) N || (N = h(document.body, "transform") ? "transform" : "-webkit-transform"), d.animatables[i].target.style[N] = r[i].join(" ");
                        ...
                        return function(e, n, r, i) {
                            if (0 <= e && 1 >= e && 0 <= r && 1 >= r) {
                                ...
                                return function(a) {
                                    ...
                                    if (.001 <= u) {
                                        for (s = 0; 4 > s && 0 !== (u = 3 * (1 - 3 * r + 3 * e) * c * c + 2 * (3 * r - 6 * e) * c + 3 * e); ++s) var l = t(c, e, r) - a,
                                            c = c - l / u;
                                        a = c
                                    } else if (0 === u) a = c;
                                    else {
                ...
                return j.version = "2.2.0", j.speed = 1, j.running = H, j.remove = function(t) {
                    ...
                    for (var e = H.length; e--;)
                        for (var n = H[e], r = n.animations, o = r.length; o--;) i(t, r[o].animatable.target) && (r.splice(o, 1), r.length || n.pause())
        ...
        ! function(i, o, a, s) {
            ...
            function U(t, e) {
                ...
                for (i = 0; i < a.length;) r[a[i].identifier] && s.push(a[i]), e & (Pt | Lt) && delete r[a[i].identifier], i++;
            ...
            K.prototype = {
                ...
                process: function(t) {
                    ...
                    if (this._input = t, !r || !n || t.eventType & (Pt | Lt) && !i) this.reset();
